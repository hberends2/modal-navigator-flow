        ...
        <div className="w-full">
          ...
          {properties.length > 1 && (
            <div className="mb-6">
              ...
              <select 
                ...
                className="w-full sm:w-72 px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              >
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="mb-6">
              <TabsTrigger value="report">Occupancy Report</TabsTrigger>
              <TabsTrigger value="forecast">Forecast Input</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="forecast" className="mt-6">
              {selectedProperty ? (
                <OccupancyForecastContent property={selectedProperty} />
              ) : (
